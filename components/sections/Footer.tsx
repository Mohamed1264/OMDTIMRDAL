        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/abdlali.ouhmad.5" className="bg-gray-800 p-3 rounded-lg hover:bg-orange-600 transition">
                <Facebook className="w-6 h-6 text-white" />
              </a>
              <a href="https://www.instagram.com/omd.timrdal?igsh=NTRlZGtnejR4amZp" className="bg-gray-800 p-3 rounded-lg hover:bg-orange-600 transition">
